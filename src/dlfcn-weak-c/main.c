...
static void test_weak_und_function_resolved(const char *path)
{
...
static void test_weak_und_function_missing(const char *path)
{
    void *handle = open_library(path, RTLD_NOW);
...
static void test_weak_und_data_resolved(const char *path)
{
    void *handle = open_library(path, RTLD_NOW);
...
static void test_weak_und_data_missing(const char *path)
{
    void *handle = open_library(path, RTLD_NOW);
...
static void test_weak_und_function_plt_resolved(const char *path)
{
    void *handle = open_library(path, RTLD_NOW);
...
static void test_weak_und_function_plt_missing(const char *path)
{
    void *handle = open_library(path, RTLD_NOW);
...
static void test_strong_und_missing(const char *path)
{
    clear_dlerror();
